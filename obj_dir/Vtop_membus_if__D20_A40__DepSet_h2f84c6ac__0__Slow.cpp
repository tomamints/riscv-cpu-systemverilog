...
VL_ATTR_COLD void Vtop_membus_if__D20_A40___ctor_var_reset(Vtop_membus_if__D20_A40* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_membus_if__D20_A40___ctor_var_reset\n"); );
